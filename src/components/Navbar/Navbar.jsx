        ...
        <div className='container w-100'>
            <div className='navbar-content flex fw-7'>
                <div className='brand-and-toggler flex flex-between w-100'>
                    <a href = "#header" className='navbar-brand fs-26' style={{color:"#5690d9"}}>SolnHub</a>
                ...
                <div className={`navbar-collapse ${navToggle ? 'show-navbar-collapse' : ""}`} onClick={navHandler}>
